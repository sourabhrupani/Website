...
<div class="register-box">
  <div class="register-box-body">
    ...
    <div class="social-auth-links text-center">
      <p>- OR -</p>
      <a href="https://accounts.google.com/SignUp" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Sign up using
        Google+</a>
		<a href="https://login.yahoo.com/account/create" class="btn btn-block btn-social btn-yahoo btn-flat"><i class="fa fa-yahoo"></i>Sign Up using Yahoo</a>
    </div>

    <a href="login_main.php" class="text-center">I already have a membership</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
